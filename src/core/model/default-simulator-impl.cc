...
DefaultSimulatorImpl::ProcessOneEvent()
{
    ...
    // std::cout << m_currentTs << std::endl;
    // std::cout << m_currentContext << std::endl;
    // std::cout << m_currentUid << std::endl;
    // std::cout << std::endl;
    // std::cout << std::endl;
...
DefaultSimulatorImpl::ProcessEventsWithContext()
{
    ...
    {
        std::cout << eventsWithContext.begin()._M_node << std::endl;
...
{
    std::cout << "JOJO2" << std::endl;
    NS_LOG_FUNCTION(this);
    // Set the current threadId as the main threadId
    m_mainThreadId = std::this_thread::get_id();
    ProcessEventsWithContext();
    m_stop = false;
    std::cout << "m_mainThreadId " << m_mainThreadId << std::endl;
