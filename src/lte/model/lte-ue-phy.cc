...
{   
    // std::cout << "RNTI CUR: " << m_rnti << std::endl; 
    // auto recep = GetSubChannelsForReception();
    // auto trans = GetSubChannelsForTransmission();

    // std::cout << "RECEP (Priem)" << std::endl;
    //         for(auto it = recep.begin(); it  != recep.end(); it++) {
    //         std::cout << *it << std::endl;
    //     }   
    // std::cout << "TRANS (Peredacha)" << std::endl;
    //         for(auto it = trans.begin(); it  != trans.end(); it++) {
    //         std::cout << *it << std::endl;
    //     }   


    // std::cout << "ReceiveLteControlMessageList" << std::endl;
    NS_LOG_FUNCTION(this);

    std::list<Ptr<LteControlMessage>>::iterator it;
    // std::cout << std::endl;
    // std::cout << "lte-ue-phy.cc, 1049: I am RNTI = " << m_rnti << " AND I RECEIVED MSGs" << std::endl;
    ...
    for (it = msgList.begin(); it != msgList.end(); it++)
    {
        ...
        if (msg->GetMessageType() == LteControlMessage::DL_DCI)
        {
            ...
            // auto recep = GetSubChannelsForReception();
            // auto trans = GetSubChannelsForTransmission();
            // std::cout << "RECEP (Priem)" << m_rnti << std::endl;
            // for(auto it = recep.begin(); it  != recep.end(); it++) {
            //     std::cout << *it << std::endl;
            // }   
            // std::cout << "TRANS (Peredacha)" << m_rnti << std::endl;
            // for(auto it = trans.begin(); it  != trans.end(); it++) {
            //     std::cout << *it << std::endl;
            // }
            // std::cout << "RBG SIZE: " << (int) GetRbgSize() << std::endl;
            // std::cout << "TTI: " << GetTti() << std::endl; 
            // std::cout << "lte-ue-phy.cc, 1109: RB SHIFT, RB BITMAP: ";
            // std::cout << (int) dci.m_rbShift << ", ";
            // std::cout << (int) dci.m_rbBitmap << std::endl;
            // for(auto it = dci.m_mcs.begin(); it  != dci.m_mcs.end(); it++) {
            //     std::cout << (int) *it << ", ";
            // }
            // std::cout << std::endl;
            if (dci.m_resAlloc != 0)
            ...
            // std::cout << "lte-ue-phy.cc, 1109: RB SHIFT, RB BITMAP: ";
            // std::cout << dci.m_rbShift << ", ";
            // std::cout << dci.m_rbBitmap << std::endl;
            // for(auto iter = dlRb.begin(); iter != dlRb.end(); iter++) {
            //     std::cout << *iter << ", ";
            // }
            //std::cout << std::endl;
